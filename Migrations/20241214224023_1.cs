        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalScoreWeight = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_completed_exams", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_completed_exams_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_completed_exams_ExamId",
                table: "completed_exams",
                column: "ExamId");

            migrationBuilder.CreateIndex(
                name: "IX_completed_exams_UserId",
                table: "completed_exams",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_exam_attempt_QuestionId",
                table: "exam_attempt",
                column: "QuestionId");
